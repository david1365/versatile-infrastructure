...
@ContextConfiguration(classes = {
        ...
        SendSmsFirstPasswordCardClient.class
})
@TestPropertySource("classpath:jms-client-test.properties")
class SendSmsFirstPasswordCardClientTest {

    @Autowired
    SendSmsFirstPasswordCardClient sendSmsFirstPasswordCardClient;

    @Test
    void sendSmsFirstPasswordCard() {

        SendSmsFirstPasswordCardRequest sendSmsFirstPasswordCardRequest = SendSmsFirstPasswordCardRequest.builder()
        ...
        assertNotNull(sendSmsFirstPasswordCardResponse);
