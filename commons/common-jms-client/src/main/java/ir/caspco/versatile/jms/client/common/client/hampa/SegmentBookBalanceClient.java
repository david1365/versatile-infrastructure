...
@Component
@JmsHeader(serviceId = "cardmanagement.message.GetSegmentBookBalanceMsg")
public class SegmentBookBalanceClient extends JmsClient<HampaGetSegmentBookBalanceRequest, HampaGetSegmentBookBalanceResponse> {
